...
class ChatPollama_ChatModels implements INode {
    label: string
    name: string
    version: number
    type: string
    ...
    constructor() {
        this.label = 'ChatPollama'
        this.name = 'chatPollama'
        this.version = 5.0
        this.type = 'ChatPollama'
        this.icon = 'Ollama.svg'
        this.category = 'Chat Polar Models'
        this.description = 'Chat completion With PolarOps'
...
module.exports = { nodeClass: ChatPollama_ChatModels }
